<div class="row">
			<div class="col-md-12">
				<center>Copyright &copy <?php echo date ('Y');?> Website Universitas Sumatera Utara, design with <span class="glyphicon glyphicon-user"></span> by Daulat Fourman Hia<br/>
